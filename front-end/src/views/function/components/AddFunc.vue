<template>
  ...
  >
    <el-form ref="addForm"
      ...
      <el-button style="width: 100%;font-size: 20px;margin-top: 5px"
                 size="mini"
      ...
      <el-form-item label="Log-topic:"
                    style="width: 100%"
                    prop="logTopic">
        <el-input v-model="form.logTopic"
                  placeholder="请输入Log-topic"
                  clearable>
        </el-input>
      </el-form-item>
...
export default {
  ...
  data() {
    return {
      ...
      rules:{
        functionName:[
          { required: true, message: '请输入FunctionName', trigger: 'blur' }
        ],
        output:[
          { required: true, message: '请输入Output', trigger: 'blur' }
        ],
        logTopic:[
          { required: true, message: '请输入Log-topic', trigger: 'blur' }
        ],
        className:[
