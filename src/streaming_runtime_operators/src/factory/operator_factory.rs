...
use crate::factory::connector::{ConnectorSinkDispatcher, ConnectorSourceDispatcher};
use crate::factory::global::Registry;
use crate::operators::grouping::IncrementalAggregatingConstructor;
use crate::operators::joins::{InstantJoinConstructor, JoinWithExpirationConstructor};
...
use crate::operators::watermark::WatermarkGeneratorConstructor;
use crate::operators::windows::{
...
impl OperatorFactory {
    ...
    fn register_builtins(&mut self) {
        ...
        crate::factory::register_kafka_connector_plugins(self);
    }
}
