...
use super::{CreateWasmTask, DropWasmTask, StartWasmTask, StopWasmTask, ShowWasmTasks};
...
pub trait StatementVisitor {
    fn visit_create_wasm_task(&self, stmt: &CreateWasmTask, context: &StatementVisitorContext) -> StatementVisitorResult;
    
    fn visit_drop_wasm_task(&self, stmt: &DropWasmTask, context: &StatementVisitorContext) -> StatementVisitorResult;
    
    fn visit_start_wasm_task(&self, stmt: &StartWasmTask, context: &StatementVisitorContext) -> StatementVisitorResult;
    
    fn visit_stop_wasm_task(&self, stmt: &StopWasmTask, context: &StatementVisitorContext) -> StatementVisitorResult;
    
    fn visit_show_wasm_tasks(&self, stmt: &ShowWasmTasks, context: &StatementVisitorContext) -> StatementVisitorResult;
}
