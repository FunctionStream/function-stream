...
pub struct StateConfig {
    ...
    /// Total bytes shared by all [`crate::core::state::OperatorStateStore`] (global pool).
...
/// Operators that create an [`crate::core::state::OperatorStateStore`] at runtime.
...
impl PipelineRunner {
    async fn run(self) -> Result<(), crate::core::error::RunError> {
        match self {
