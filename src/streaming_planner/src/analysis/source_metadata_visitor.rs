...
use crate::logical_node::sink::{STREAM_EGRESS_NODE_NAME, StreamEgressNode};
use crate::logical_node::table_source::{STREAM_INGESTION_NODE_NAME, StreamIngestionNode};
...
impl<'a> SourceMetadataVisitor<'a> {
    ...
    fn get_connection_id(&self, node: &LogicalPlan) -> Option<i64> {
        ...
        match table {
            crate::schema::table::CatalogEntity::ExternalConnector(b) => match b.as_ref() {
                crate::schema::catalog::ExternalTable::Source(t) => t.registry_id,
                crate::schema::catalog::ExternalTable::Lookup(t) => t.registry_id,
                _ => None,
            },
            _ => None,
        }
