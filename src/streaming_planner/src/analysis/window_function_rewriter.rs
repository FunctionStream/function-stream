...
use crate::analysis::streaming_window_analzer::{StreamingWindowAnalzer, extract_column};
...
use crate::types::{WindowType, build_df_schema, extract_qualified_fields};
...
pub struct WindowFunctionRewriter;
...
impl WindowFunctionRewriter {
    ...
    fn identify_window_partition(
        ...
        input: &LogicalPlan,
        input_window_fields: &std::collections::HashSet<crate::types::QualifiedField>,
    ) -> DFResult<usize> {
