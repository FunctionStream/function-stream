...
pub mod aggregate_rewriter;
pub mod join_rewriter;
pub mod row_time_rewriter;
pub mod stream_rewriter;
pub mod streaming_window_analzer;
pub mod window_function_rewriter;
...
pub use crate::schema::schema_provider::StreamSchemaProvider;
...
use crate::logical_node::StreamingOperatorBlueprint;
use crate::logical_node::key_calculation::{KeyExtractionNode, KeyExtractionStrategy};
use crate::logical_node::projection::StreamProjectionNode;
use crate::logical_node::sink::StreamEgressNode;
use crate::logical_planner::planner::NamedNode;
...
pub fn maybe_add_key_extension_to_sink(plan: LogicalPlan) -> Result<LogicalPlan> {
