...
use crate::logical_node::aggregate::{STREAM_AGG_EXTENSION_NAME, StreamWindowAggregateNode};
use crate::logical_node::join::STREAM_JOIN_NODE_TYPE;
use crate::types::{
...
pub struct StreamingWindowAnalzer {
...
impl StreamingWindowAnalzer {
    ...
    pub fn get_window(logical_plan: &LogicalPlan) -> Result<Option<WindowType>> {
...
pub fn extract_column(expr: &Expr) -> Option<&Column> {
    match expr {
