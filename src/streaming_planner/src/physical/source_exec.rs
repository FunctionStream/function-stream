...
use crate::common::constants::physical_plan_node_name;
...
pub fn create_unbounded_stream_properties(schema: SchemaRef) -> PlanProperties {
    PlanProperties::new(
...
pub fn make_stream_properties(schema: SchemaRef) -> PlanProperties {
...
#[derive(Debug)]
pub struct InjectableSingleBatchExec {
    schema: SchemaRef,
...
#[derive(Debug)]
pub struct BufferedBatchesExec {
    schema: SchemaRef,
