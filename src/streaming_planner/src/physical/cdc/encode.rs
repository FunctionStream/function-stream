...
use crate::common::constants::{cdc, debezium_op_short, physical_plan_node_name};
use crate::common::{TIMESTAMP_FIELD, UPDATING_META_FIELD};
use crate::physical::source_exec::make_stream_properties;
...
impl CdcDebeziumPackExec {
    ...
    pub fn from_decoded_parts(input: Arc<dyn ExecutionPlan>, schema: SchemaRef) -> Self {
        Self {
