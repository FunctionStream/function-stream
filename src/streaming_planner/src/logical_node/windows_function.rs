...
use crate::common::constants::{extension_node, proto_operator_name, runtime_operator_kind};
...
pub const STREAMING_WINDOW_NODE_NAME: &str = extension_node::STREAMING_WINDOW_FUNCTION;
...
pub struct StreamingWindowFunctionNode {
