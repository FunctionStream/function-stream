...
use super::ros_common::{DEFAULT_ROS2_URL, build_ros_source_config};

/// ROS2 live source via `rosbridge_server` (same WebSocket protocol as ROS1).
pub struct Ros2SourceConnector;

impl SourceProvider for Ros2SourceConnector {
