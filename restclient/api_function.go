...
func (r ApiGetAllFunctionsRequest) Execute() (*http.Response, error) {
...
// Execute executes the request
func (a *FunctionAPIService) GetAllFunctionsExecute(r ApiGetAllFunctionsRequest) (*http.Response, error) {
	var (
